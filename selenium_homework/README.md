...
Case 5 – REST API testing
    ...
    Add Rest Api library for the test project
    Create and send request: Request type: GET Host: https://jsonplaceholder.typicode.com Endpoint: /users
    Parse response to Json format
    Log only the names and emails from the response data Example: Leanne Graham | Sincere@april.biz Ervin Howell | Shanna@melissa.tv
